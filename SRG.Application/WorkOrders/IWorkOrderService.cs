...
{
    Task<List<WorkOrderResponse>> GetWorkOrdersAsync(Guid userId, string role, CancellationToken cancellationToken = default);
    ...
    Task<WorkOrderResponse> AddOrderedMaterialAsync(Guid id, AddOrderedMaterialRequest request, Guid userId, CancellationToken cancellationToken = default);
